...
//        }
            ...
            $.ajax({
                ...
                success: function (result) {
                    ...
                    if (getCookieValue("GisMode") == "gis") {
                        window.document.getElementById('Iframe1').src = '/Common/MGIS/SmallGIS.htm?Category_Code=3C&Width=0.5&CenterLon=' + json[0].GIS_X + "&CenterLat=" + json[0].GIS_Y + '&v=' + version;
                    }
                    else {
                        window.document.getElementById('Iframe1').src = '/Common/MTopo/LogicTopo.html?Category_Code=3C&Width=0.5&Small=small&centerLon=' + json[0].GIS_X + "&centerLat=" + json[0].GIS_Y + '&v=' + version;
                    }
                }
            });
        };
        ...
        function onClickIframeTwo(loco) {
            locomotiveCode = loco;
            document.getElementById('Iframe2').src = "../MLiveStreaming/MonitorLocoPlayMini.htm?page=meta_22&IsP=YES&locomotiveCode=" + loco + '&v=' + version;
        ...
        function clickRealPlayTwo() {
            ...
            if (locomotiveCode == '') {
                locomotiveCode = $('#Iframe2').contents().find('#locomotive_no').text();
            }
        ...
        function clickRealPlayTwoAll() {
            document.getElementById("Iframe2").src = "../MLiveStreaming/MonitorLocoPlayMini.htm?page=meta_22&IsP=YES&locomotiveCode=" + locomotiveCode + '&v=' + version; //先上值，等开发完成
            document.getElementById("allimg").style.display = "none";
            document.getElementById("Iframe3").style.display = "";
        ...
        function loadC3GIS() {
            $("#Iframe1").attr("src", "/Common/MGIS/SmallGIS.htm?Width=0.5&Category_Code=3C&v=" + version);
        };
        function loadC3SP() {
            //$("#Iframe2").attr("src", "../MLiveStreaming/MonitorLocoPlayMini.htm?page=meta_22&IsP=YES&locomotiveCode=" + locomotiveCode);

            $("#Iframe2").attr("src", "/C3/PC/MLiveStreaming/MonitorLocoPlayNew.htm?v=" + version);
            ...
            <table border="1" cellpadding="1" cellspacing="1" style="height: 100%; width: 100%">
                <tr>
                    <td style="height: 50%; width: 50%">
                        ...
                        <iframe id="IframeJtopo" scrolling="no" src="" style="width: 100%; display: none;"
                            frameborder="0"></iframe>
                ...
                <tr>
                    ...
                    <td style="height: 50%; width: 50%">
                        ...
                        <img id="allimg" src="#"  onclick="allimgck()" style="height: 370px; width: 100%; display: none" />
