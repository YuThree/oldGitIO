...
$(function () {
    ...
    // 初始化插件参数及插入插件
    WebVideoCtrl.I_InitPlugin(780, 470, {
        iWndowType: 1,
...
function TreeClick(name, id, type) {
    if (type == "BUREAU") {
        ...
        document.getElementById('locomotive_no').innerHTML = id;
        document.getElementById('locomotiveSect').innerHTML = '';
        document.getElementById('useSector').innerHTML = '';
        document.getElementById('last_running_time').innerHTML = '';
        document.getElementById('routing_no').innerHTML = '';
        document.getElementById('running_section').innerHTML = '';
        document.getElementById('train_number').innerHTML = '';
        document.getElementById('driver_no').innerHTML = '';
        stopRealPlay();
    }
    doQuery();
}
