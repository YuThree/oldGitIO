<%@ page language="C#" enablesessionstate="true" autoeventwireup="true" inherits="CoverDimensionName, App_Web_kp2n3dje" %>
    ...
    <body style="background-color: #D0D0D0;">
        ...
        <div>
            ...
            <rsweb:ReportViewer ID="ReportViewer3" runat="server" Font-Names="Verdana" Font-Size="8pt"
                ...
                <LocalReport ReportPath="Common\LineCoverage\rdlc\CoverDimensionName.rdlc">
                    <DataSources>
