...
CommonPerson.Base.LoadingPic = {
    ...
    FullScreenShow: function (msg) {
        ...
        if ($("#div_loadingImg").length == 0) {
            $("body").append("<div id='div_loadingImg'><div id='loadingPage_bg' class='loadingPage_bg1'></div><div id='loadingPage_1'>" + msg + "</div></div>");
        ...
        //                $("#div_loadingImg").append("<div id='loadingPage_bg' class='loadingPage_bg1'></div><div id='loadingPage_1'>" + msg + "</div>");
        //                $("#loadingPage_bg").height($(top.window.document).height()).width($(top.window.document).width());
        //            }, 500);
        //        }
