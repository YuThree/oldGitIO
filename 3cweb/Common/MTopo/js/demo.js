...
(function(){
	var demos = [
		...
		{text:'节点报警', href:'topo-node-alarm.html'},	
		...
		'其他',		
		{text:'舞台模式', href:'stage-mode.html'},
		{text:'canvas滚动', href:'canvas-scroll.html'},
	...
	$(document).ready(function(){
		...
		var canvas = $('<canvas width="1300" height="1000">').attr('id', 'canvas').appendTo(content);
		canvas.css({
