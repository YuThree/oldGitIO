<%@ page language="C#" enablesessionstate="true" autoeventwireup="true" inherits="Report_C5DetectReport, App_Web_bayfktcg" %>
    ...
    <body style="background-color: #D0D0D0;">
        ...
        <div>
            ...
            <rsweb:ReportViewer ID="ReportViewer2" runat="server" Font-Names="Verdana" Font-Size="8pt"
                ...
                <LocalReport ReportPath="Report\rdlc\C5\C5DetectReport.rdlc">
                    <DataSources>
