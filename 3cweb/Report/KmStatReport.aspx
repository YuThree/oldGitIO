<%@ page language="C#" enablesessionstate="true" autoeventwireup="true" inherits="Report_KmStatReport, App_Web_tphaj34x" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="reportViewer" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            <LocalReport ReportPath="Report\rdlc\KMReport.rdlc">
                <DataSources>
