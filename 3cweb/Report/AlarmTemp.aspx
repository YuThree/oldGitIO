<%@ page language="C#" enablesessionstate="true" autoeventwireup="true" inherits="Report_AlarmTemp, App_Web_bayfktcg" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="reportViewer" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            <LocalReport ReportPath="Report\rdlc\AlarmTemp.rdlc">
                <DataSources>
