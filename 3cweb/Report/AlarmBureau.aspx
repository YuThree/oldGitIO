<%@ page language="C#" enablesessionstate="true" autoeventwireup="true" inherits="C3_AlarmBureau, App_Web_tphaj34x" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="reportViewer" runat="server" Font-Names="Verdana" Font-Size="8pt"
            ...
            <LocalReport ReportPath="Report\rdlc\AlarmBureau.rdlc">
                <DataSources>
