<%@ page language="C#" enablesessionstate="true" autoeventwireup="true" inherits="Report_3CTaskReport, App_Web_tphaj34x" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="650px"
            ...
            <LocalReport ReportPath="Report\rdlc\DPC\3CTaskReport.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
