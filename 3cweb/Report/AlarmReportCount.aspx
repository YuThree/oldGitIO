<%@ page language="C#" enablesessionstate="true" autoeventwireup="true" inherits="C3_PC_MReport_AlarmReportCount, App_Web_bayfktcg" %>
    ...
    <body style="background-color: #D0D0D0;">
        ...
        <div>
            ...
            <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                ...
                <LocalReport ReportPath="Report\rdlc\AlarmRportCount.rdlc">
                    <DataSources>
