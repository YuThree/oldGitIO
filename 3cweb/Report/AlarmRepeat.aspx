<%@ page language="C#" enablesessionstate="true" autoeventwireup="true" inherits="Report_AlarmRepeat, App_Web_bayfktcg" %>
    ...
    <body style="background-color: #D0D0D0;">
        ...
        <div>
            ...
            <rsweb:ReportViewer ID="reportViewer" runat="server" Font-Names="Verdana" Font-Size="8pt"
                Height="1400px" InteractiveDeviceInfos="(集合)" 
                WaitMessageFont-Names="Verdana" ShowRefreshButton=false
                WaitMessageFont-Size="14pt" Width="830px" BackColor="White" 
                PageCountMode="Actual" onprerender="reportViewer_PreRender">
                <LocalReport ReportPath="Report\rdlc\AlarmRepeat.rdlc">
                    <DataSources>
