<%@ page language="C#" enablesessionstate="true" autoeventwireup="true" inherits="Report_2CTaskReport, App_Web_bayfktcg" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="650px"
            ...
            <LocalReport ReportPath="Report\rdlc\DPC\2CTaskReport.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
