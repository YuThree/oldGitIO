<%@ page language="C#" enablesessionstate="true" autoeventwireup="true" inherits="Report_C2Report, App_Web_bayfktcg" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="reportViewer" runat="server" Height="640px" Width="100%"
            ...
            <LocalReport ReportPath="Report\rdlc\C2\C2Report.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
