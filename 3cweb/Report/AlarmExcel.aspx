<%@ page language="C#" enablesessionstate="true" autoeventwireup="true" inherits="C3_PC_MReport_AlarmExcel, App_Web_tphaj34x" %>
...
<body>
    ...
    <div>
        ...
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="100%" Height="650px"
            ...
            <LocalReport ReportPath="Report\rdlc\AlarmExcel.rdlc">
            </LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
